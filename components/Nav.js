...
import { AnnotationIcon ,  GlobeAltIcon, LightningBoltIcon, MailIcon, ScaleIcon, MenuIcon, XIcon  } from '@heroicons/react/outline'
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex text-white space-x-4 px-3 py-2  text-sm font-medium">
                    {navigation.map((item) => (
                      <div key={item?.name} className='hover:bg-gray-700 rounded-md hover:text-white px-3 py-2'>
                        <Link
